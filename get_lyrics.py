...
headers = {'Authorization': 'Bearer ggtZ3yMZlWxVXnwMZyRzDhtLLWpLX39bxMdrccRhrEfZLkRaCpcCdtxmGR1GnjN7'}
...
def get_song_id_from_name():
	...
	for res in json["response"]["hits"]:
		if res["result"]["primary_artist"]["name"].upper() == ARTIST_NAME.upper():
...
def main():
	check_args()
	print(get_lyrics_from_path(get_web_path_from_song_id(get_song_id_from_name())));
